# from the NSA's System Integrity Monitoring Platform (SIMP) set of # modules purpose built for managing STIG compliant systems
...
# Community Modules mod 'stahnma/epel'
...
#NSA regulatory compliant modules #These modules are only compatible with # RHEL based Linux distros
#
# Note this is an example of how to pull these modules from git.
# You should NOT pull directly from github. Use a local git
# repository or add these modules directly to your control
# repository in r10k.
# This SIMP fork of the augeasproviders_grub module has required
# bug  xes. Using the fork won't be necessary once PR #14 is
# merged and a new version of the herculesteam/augeasprovider_grub
# module is released
